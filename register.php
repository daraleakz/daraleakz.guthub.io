...
?>
    ...
    <title>feds.blog - register</title>
...
opacity: 0.4; /* Firefox */
    ...
    <form id='register-form' method="POST" action="">
        <input type="text" style="color:white;background-color:#696969" id="username" placeholder="Username" data-val="true" data-val-required="The Login field is required." name="username" required>
        <input type="password" style="color:white;background-color:#696969" id="password" placeholder="Password" data-val="true" data-val-required="The Password field is required." name="password" required>
        <input type="password" style="color:white;background-color:#696969" id="confirmpassword" placeholder="Confirm Password" data-val="true" data-val-required="The Password Confirmation field is required." name="confirmpassword" required>
        <input type="text" style="color:white;background-color:#696969" id="invitecode" placeholder="Invite Code" data-val="true" data-val-required="The Invite Code field is required." name="invitecode" required>
        <div class="btn-group" role="group">
            <br>
            <input type="hidden" name="action" value="submit_register">
            <button data-sitekey="6LfwzG4iAAAAAI8zFD6H7IwbDB8ov6_PRB_qDFvQ" data-callback="onSubmit" data-action='submit' name="register_button" style="color:white;background-color:#696969" style="margin-top: 10px" data-original-title="By clicking register, you agree to our terms of service">Register</button>
        </div>
        <br>
        <small id="loginHelp" class="form-text text-muted mx-auto">Already registered? <a href="./login.php" class="text-muted link-secondary">Sign in.</a></small>
            ...
            <div style="
                ...
                margin-top: 10px;
            ">
                <a href="https://discord.gg/camlock" target="_blank" rel="noopener noreferrer">
